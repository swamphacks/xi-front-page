<script lang="ts">
    ...
    let generalFaqs = [
        {
            ...
            answer: 'SwampHacks is a 36-hour event, where participants collaborate in teams to create solutions, typically in the form of software and hardware projects. Participants can work in teams or individually to develop and build innovative solutions.'
        },
        {
        ...
        },
        {
            ...
            answer: 'No experience, no problem! We welcome participant of all skill levels. The idea is that throughout the event, we will support you through workshops and mentors available around the clock.'
        },
        {
            question: 'It\'s my first hackathon. Should I apply?',
            answer: 'Yes! We highly encourage and want first time hackers to apply. We’re dedicated to providing experiential learning opportunities for those early in their computing journey.'
        },
        {
            question: 'How can I prepare for the hackathon?',
            answer: 'You can prepare by familiarizing yourself with coding languages or tools, you are looking to use/explore, brushing up on project management skills, and collaboration. However, everything you need will be available during the hackathon.'
        },
        {
            question: 'How much does it cost to participate?',
            answer: 'Nothing! SwampHacks is completely free for all student accepted to the event. However, SwampHacks is unable to cover transportation costs at this time.'
        },
        {
            question: 'Is SwampHacks in-person or virtual?',
            answer: 'SwampHacks is FULLY in-person! Everything from check-in to judging will occur at our venue. Make sure you are able to attend in-person before registering.'
        }
    ];
    ...
    let cadeFaqs = [
        {
            ...
            answer: 'SwampHacks will be 36-hours beginning Friday (January 23rd) evening and going until Sunday (January 25th) afternoon.'
        },
        {
            question: 'What can I build?',
            answer: 'Anything from a chill video game for you and your friends, to a supercharged sofa go kart! You have 36 hours to make something a reality, so make it count.\n\nIt is important to note that your project does not have to be fully developed as you will be allowed to present *prototypes* for the product idea that you have developed.'
        },
        {
    ...
    let harnFaqs = [
        {
            ...
            answer: 'Yes, meals, snacks, and drinks will be provided throughout the hackathon to help keep you energized.'
        },        
        {
            question: 'Do I have to stay the whole time?',
            answer: 'You are welcome to leave and return to the venue(s) during the hackathon. However, we recommend to stay to maximize your time with your team, mentors, and the community. For overnight, we ask that you limit leaving and returning to the venue due to security.'
        },
        {
            question: 'Are there showers available?',
            answer: 'There are not showers available inside of our venue(s). However, the J. Wayne Reitz Student Union has showers available on the Lower Level, which you can use during the open hours.'
        },
        {
            question: 'Where can I sleep?',
            answer: 'If you would like to keep working on your project throughout the night, we will have a venue open to continue your collaboration and work. However, if you plan on sleeping through the night, we recommend that you head back to your place of residence.'
        }
    ];
    ...
    let museumFaqs = [
        ...
        },
        {
            ...
            answer: 'On November 17th, we will be having a volunteer/mentor info session. More details will come out as we get closer. See our instagram or discord server for all.'
        },
        {
            question: 'Who can be a mentor?',
            answer: 'Who? We welcome all who have prior hackathon experience, industry, or can assist those in need with basic project needs.\n\nHow? Sign Up MentorLink'  
        },
        {
            question: 'How can I become a judge?',
            answer: 'We welcome individuals with prior hackathon experience, who are industry professionals or involved in academia. Please email contact@swamphacks.com with the subject “SwampHacks XI Judging Interest”.'
        }
    ];
</script>

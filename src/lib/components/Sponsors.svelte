<script>
	...
	import Vobile from '$lib/assets/sponsor-logos/vobile.svg';
...
{#if client}
	<section
		class="relative my-60 min-h-[420px] w-full md:min-h-[520px] lg:my-80 lg:min-h-[600px]"
	>
		...
		<div class="absolute inset-0">
			<img
				src={LakeImg}
				alt="Lake Background"
				class="absolute top-1/2 left-1/2 w-[700%] max-w-none -translate-x-1/2 -translate-y-1/2 object-cover md:w-[210%] 2xl:w-[120%]"
			/>
		</div>

		<!-- Content Container - Positioned over the lake -->
		<div
			class="relative mx-auto max-w-[90%] p-4 md:max-w-5xl md:p-10 lg:max-w-[70%] 2xl:max-w-[60%]"
		>
			<!-- Title Section -->
